    ...
    <Card className="border-2 shadow-xl">
      <CardHeader className="text-center space-y-2">
        ...
        <CardDescription className="text-base">
          Elige prompts para rastrear el rendimiento de tu marca
        </CardDescription>
      </CardHeader>
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-12 space-y-4">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Generando sugerencias de prompts impulsadas por IA...
            </p>
          </div>
        ) : (
          <>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                          ~{prompt.estimatedImpressions.toLocaleString()} búsquedas mensuales
                        </p>
                      </div>
                    </div>
                  </button>
            ...
            <div className="border-t pt-4">
              {!showCustomInput ? (
                ...
                >
                  ...
                  <span className="font-medium">Agregar Prompt Personalizado</span>
                </button>
              ) : (
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-purple-600 dark:text-purple-400">
                    {selectedPrompts.length} prompt{selectedPrompts.length !== 1 ? 's' : ''} seleccionado{selectedPrompts.length !== 1 ? 's' : ''}
                  </p>
                </div>
